...
public class ALRadialMenu: UIButton {
    ...
    /** ALDO
     Set an appeareance to the overlay view that shows the buttons
     
     Default = UIColor(0,0,0,0)
     
     - parameter UIColor: The color for the overlayView
     */
    public func setOverlayViewAppeareance(color: UIColor) -> Self {
        self.overlayView.backgroundColor = color
        return self
    }
    
    /** ALDO
     Configure if Menu button has to hide when showing buttons
     
     Default = false
     
     - parameter Bool: To indicate if Menu button hides or not
     */
    public func hideMenuButtonWhenShowingButtons(hide: Bool) -> Self {
        self.hideMenu = hide
        return self
    }
    ...
    */
    public func presentInView(view: UIView, senderButton: UIView) -> Self {
        return presentInWindow(win: view.window!, senderButton: senderButton)
    }
    ...
    */
    public func presentInWindow(win: UIWindow, senderButton: UIView) -> Self {
        ...
        //////////
        senderButton.isHidden = self.hideMenu
    ...
    */
    ...
    private var hideMenu: Bool = false
    private var senderButton: UIView!
    ...
    private func _dismiss(selectedIndex: Int) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.2, execute: {
            ...
            self.senderButton.isHidden = !(self.hideMenu)
        })
